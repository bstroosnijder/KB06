...
namespace Game
{
	...
	void Gui::UpdateMenu()
	{
		...
		if (!m_menuIsActive)
		{			
			m_menu = m_guiEnvironment->addImage(irr::core::rect<irr::s32>((m_screenWidth/2)-100, (m_screenHeight/2)-100, (m_screenWidth/2)+100, (m_screenHeight/2)+100));
			m_menu->setImage(m_guiEnvironment->getVideoDriver()->getTexture("resources/textures/bar.png"));
			m_menu->setScaleImage(true);

			irr::gui::IGUIButton* returnButton = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(35,65,140,80), m_menu, BUTTON_MENU,L"Return", L"Returns to the game");
			...
			irr::gui::IGUIButton* quitButton = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(35,95,140,110), m_menu, BUTTON_STOP_GAME,L"Quit", L"Exits program");
	...
	void Gui::UpdateControlsMenu()
	{
		...
		{
			m_controls = m_guiEnvironment->addImage(irr::core::rect<irr::s32>((m_screenWidth/2)-100,(m_screenHeight/2)-100,(m_screenWidth/2)+100,(m_screenHeight/2)+100));
			...
			irr::gui::IGUIButton* returnButton = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(35,65,140,80),m_controls, BUTTON_CONTROLS_MENU,L"Return", L"Returns to the game");
			returnButton->setImage(m_guiEnvironment->getVideoDriver()->getTexture("resources/textures/button.png"));
			returnButton->setScaleImage(true);
	...
	{		
		if (p_endGame == 4)
		{
			...
			{
				irr::gui::IGUIImage* victory = m_guiEnvironment->addImage(irr::core::rect<irr::s32>((m_screenWidth/2)-300,(m_screenHeight/2)-169,(m_screenWidth/2)+300,(m_screenHeight/2)+169),0,5);
		...
		else if (p_endGame == 1)
		{
			...
			{
				irr::gui::IGUIImage* defeat = m_guiEnvironment->addImage(irr::core::rect<irr::s32>((m_screenWidth/2)-300,(m_screenHeight/2)-169,(m_screenWidth/2)+300,(m_screenHeight/2)+169),0,5);
	...
	void Gui::ShowVictory(PlayerType p_playerType)
	{
		...
		m_imageVictory = m_guiEnvironment->addImage(irr::core::rect<irr::s32>((m_screenWidth/2)-300,(m_screenHeight/2)-169,(m_screenWidth/2)+300,(m_screenHeight/2)+169),0,5);
	...
	void Gui::CreateGUIControls()
	{
		...
		//Sidebar
		m_imageSidebar = m_guiEnvironment->addImage(m_guiEnvironment->getVideoDriver()->getTexture("resources/textures/sidebar.png"),irr::core::position2d<int>(m_screenWidth-200,0));
		...
		m_buttonAttackersTurn = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 10, midPositionSidebar+buttonWidth/2, 40), m_imageSidebar, BUTTON_ATTACKERS_TURN, L"Attackers Turn");
		m_buttonAttackersTurn->setImage(m_textureButton);
		m_buttonAttackersTurn->setScaleImage(true);

		//Button Buy Pencil
		m_buttonBuyPencil = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 50, midPositionSidebar+buttonWidth/2, 80), m_imageSidebar, BUTTON_BUY_PENCIL, L"Buy Pencil");
		...
		//Button Create Tower
		m_buttonCreateTower = m_guiEnvironment->addButton(irr::core::recti(midPositionSidebar-buttonWidth/2, 170, midPositionSidebar+buttonWidth/2, 200), m_imageSidebar, BUTTON_CREATE_TOWER, L"Create Tower");
		m_buttonCreateTower->setImage(m_textureButton);
		m_buttonCreateTower->setScaleImage(true);

		//Button Delete Tower
		m_buttonDeleteTower = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 210, midPositionSidebar+buttonWidth/2, 240), m_imageSidebar, BUTTON_DELETE_TOWER, L"Delete Tower");
		m_buttonDeleteTower->setImage(m_textureButton);
		m_buttonDeleteTower->setScaleImage(true);

		//Button Upgrade Tower Speed
		m_buttonUpgradeTowerSpeed = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 250, midPositionSidebar+buttonWidth/2, 280), m_imageSidebar, BUTTON_UPGRADE_TOWER_SPEED, L"Upgrade Tower Speed");
		m_buttonUpgradeTowerSpeed->setImage(m_textureButton);
		m_buttonUpgradeTowerSpeed->setScaleImage(true);

		//Button Upgrade Tower Range
		m_buttonUpgradeTowerRange = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 290, midPositionSidebar+buttonWidth/2, 320), m_imageSidebar, BUTTON_UPGRADE_TOWER_RANGE, L"Upgrade Tower Range");
		...
		m_buttonUpgradeTowerDamage = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 330, midPositionSidebar+buttonWidth/2, 360), m_imageSidebar, BUTTON_UPGRADE_TOWER_RANGE, L"Upgrade Tower Damage");
		m_buttonUpgradeTowerDamage->setImage(m_textureButton);
		m_buttonUpgradeTowerDamage->setScaleImage(true);

		//Button Controls Menu
		m_buttonControlsMenu = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 410, midPositionSidebar+buttonWidth/2, 440), m_imageSidebar, BUTTON_CONTROLS_MENU, L"Controls");
		m_buttonControlsMenu->setImage(m_textureButton);
		m_buttonControlsMenu->setScaleImage(true);

		//Button Start Wave
		m_buttonStartWave = m_guiEnvironment->addButton(irr::core::rect<irr::s32>(midPositionSidebar-buttonWidth/2, 450, midPositionSidebar+buttonWidth/2, 480), m_imageSidebar, BUTTON_START_WAVE, L"Start Wave");
