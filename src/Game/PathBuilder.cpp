...
bool PathBuilder::IsPathDirectionAllowed(Path* p_path, PathPoint* p_pathPoint1, PathPoint* p_pathPoint2)
{
	...
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:IsPathDirectionAllowed: Invalid parameters");
		return false;
	}
		...
		PathPoint* p_pathPointCurrent)
{
	...
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:BuildRoute: Invalid parameters");
		return;
	}
		...
		int p_pointsCount)
{
	...
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:CreatePathPoints: Invalid parameters");
		return NULL;
	}
	else if (p_pointsCount < 1)
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:CreatePathPoints: Point count is lower then 1");
	}
...
void PathBuilder::PathJoinPathPoints(Path* p_path, float p_range)
{
	if (p_path == NULL)
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:PathJoinPathPoints: Invalid parameters");
		return;
	}
	else if (p_range < 0)
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:PathJoinPathPoints: Range is lower then 0");
	}
		...
		float p_range)
{
	if (p_path == NULL)
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:PathDetermineBeginAndEndPathPoints: Invalid parameters");
	}
	else if (p_range < 0)
	{
		Logger::GetInstance()->Log(Logger::LOG_ERROR, "PathBuilder:PathDetermineBeginAndEndPathPoints: Range is lower then 0");
	}
